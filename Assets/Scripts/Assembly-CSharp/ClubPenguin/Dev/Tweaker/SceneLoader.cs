...
namespace ClubPenguin.Dev.Tweaker
{
	public static class SceneLoader
	{
        ...
        [Invokable("SceneLoader.PenglantianVault")]
        private static void LoadPenglantianVault()
        {
            LoadScene("EventPirateParty");
        }

        [Invokable("SceneLoader.MedievalDungeon")]
        private static void LoadMedievalDungeon()
        {
            LoadScene("EventMedievalDungeon1");
        }
