...
namespace ClubPenguin.Input
{
    public class LocomotionMouseInput : LocomotionInput
    {
        ...
        protected override bool process(int filter)
        {
            ...
            Vector2 currentMousePosition = Mouse.current != null ? Mouse.current.position.ReadValue() : previousMousePosition;
            bool flag = previousMousePosition != currentMousePosition;
