...
namespace ClubPenguin.UI
{
	public class UIDisabler : MonoBehaviour
	{
		...
		private IEnumerator cullCamera()
		{
			...
			{
				Debug.LogWarning("UIDisabler.cullCamera: Camera.main is null - skipping culling.");
			}
		}
		...
		private void restoreCamera()
		{
			...
			{
				Debug.LogWarning("UIDisabler.restoreCamera: Camera.main is null - skipping restore.");
			}
		}
	}
}
