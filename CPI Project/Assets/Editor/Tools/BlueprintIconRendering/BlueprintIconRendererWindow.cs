...
public class BlueprintIconRendererWindow : EditorWindow
{
    ...
    private const string OutlineShaderPath = "Assets/Editor/Tools/BlueprintIconOutline.shader";
    ...
    private void DrawTemplateSelection()
    {
        ...
        if (EditorGUI.EndChangeCheck() && selectedTemplate != null)
        {
            LoadRenderData();
            DestroyRenderedIcon();
        }
    ...
    private void DrawRenderAndSave()
    {
        ...
        if (GUILayout.Button("Render Blueprint Icon", GUILayout.Height(32f)))
        {
            RenderBlueprintIcon();
        }
    ...
    private void RenderBlueprintIcon()
    {
        DestroyRenderedIcon();
        ...
        int renderLayer = 31;
        GameObject root = new GameObject("EquipmentRender");
        ...
        RenderTexture rt = RenderTexture.GetTemporary(IconSize, IconSize, 24, RenderTextureFormat.ARGB32);
        rt.antiAliasing = 4;
